  ...
  return (
    <section id="venue" className="section-cream py-24 px-4 relative overflow-hidden" style={{ scrollMarginTop: '60px' }}>
      ...
      <div className="text-center mb-14">
        <p className="section-label mb-3" data-reveal data-delay="1">Where We Celebrate</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12" data-reveal>
          <h3
            className="font-heading text-ink/90 mb-3"
          ...
          <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <p className="font-body text-[13px] text-ink/55">{address}</p>
          </div>
          <p className="font-body text-[11px] tracking-widest uppercase text-ink/35 mt-1">
            30 July 2026 · Arrival from 12:30 PM
          </p>
        </div>

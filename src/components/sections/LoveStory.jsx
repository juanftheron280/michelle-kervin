            ...
            >
              <div className={`flex flex-col md:flex-row items-center gap-8 md:gap-0 ${isLeft ? '' : 'md:flex-row-reverse'}`}>
                ...
                <div className="w-full md:w-1/2">
                  <div
                    className={`${isLeft ? 'md:pl-14' : 'md:pr-14'}`}
                  >
                    {card.photo ? (
                      <img
                        src={card.photo}
                      ...
                      /* Placeholder until photos are provided */
                      <div
                        className="w-full flex items-center justify-center"
                        style={{
                          aspectRatio: '4/3',
                          border: '1px solid rgba(201,169,110,0.25)',
                          background: 'linear-gradient(135deg, rgba(201,169,110,0.04) 0%, rgba(201,169,110,0.08) 100%)',
                        }}
                      >
                        <p className="font-body text-[10px] tracking-[0.2em] uppercase text-ink/25">
                          Photo coming soon
                        </p>
                      </div>
                    )}

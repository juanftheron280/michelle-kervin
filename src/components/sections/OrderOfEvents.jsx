...
const icons = {
  arrival: (
    <svg width="72" height="72" viewBox="0 0 40 28" fill="none" aria-hidden="true">
  ...
  camera: (
    <svg width="72" height="72" viewBox="0 0 38 30" fill="none" aria-hidden="true">
  ...
  champagne: (
    <svg width="72" height="72" viewBox="0 0 30 38" fill="none" aria-hidden="true">
  ...
  dinner: (
    <svg width="72" height="72" viewBox="0 0 36 32" fill="none" aria-hidden="true">
  ...
  dance: (
    <svg width="72" height="72" viewBox="0 0 32 38" fill="none" aria-hidden="true">
                ...
                {isLeft && (
                  <div className="flex items-center gap-5">
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-body font-semibold text-[14px] text-ink/85 leading-snug">{ev.label}</p>
                      <p className="font-body text-[11px] italic text-ink/45 leading-snug mt-0.5">{ev.detail}</p>
                    </div>
                    {/* Icon inner, adjacent to center line */}
                    <div className="flex-shrink-0" style={{ opacity: 0.85 }}>{ev.icon}</div>
                  </div>
                )}
              </div>
